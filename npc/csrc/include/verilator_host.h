...
NpcVerilatorHost *npc_verilator_host_create(int argc, char **argv,
                                             const NpcOptions *options, char *error,
                                             size_t error_size);
...
void npc_verilator_host_update_devices(NpcVerilatorHost *host);
